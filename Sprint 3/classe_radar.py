...
class Radar:
    ...
    def get_radar(self):
        ...
        for i in range(0,359):
                cv2.circle(self.img,(self.CalculerPointX(tab_x[i]),self.CalculerPointY(tab_y[i])),10,(125,125,125),-1)
        ...
        cv2.rectangle(self.img, (self.FENETRE_CENTRE_X - 26, self.FENETRE_CENTRE_Y - 24), (self.FENETRE_CENTRE_X + 26, self.FENETRE_CENTRE_Y + 24), (255,0,0), 2)
